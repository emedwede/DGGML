...
namespace CMA {
    ...
    public:
        void initialize() override
        {
            ...
            create_growing_rules();
            create_retraction_rules();
            create_boundary_rules();
            create_zippering_rules();
            create_crossover_rules();
            create_collision_rules();
            create_destruction_rules();
            create_creation_rules();
            create_clasp_rules();
            create_recovery_rules();
