...
//checks if we're outside a circular boundary
    ...
    void create_growing_rules(DGGML::Grammar<Plant::graph_type> &gamma, Plant::graph_type &system_graph,
                              Parameters &settings) {
        ...
        DGGML::WithRule<GT> stochastic_mt_growth("stochastic_mt_growth", mt_growth_lhs, mt_growth_rhs,
                                                 [&](auto &lhs, auto &m) {
                                                     ...
                                                     double propensity =
                                                             100.0 * DGGML::heaviside(len, settings.DIV_LENGTH);
    ...
    void create_retraction_rules(DGGML::Grammar<Plant::graph_type> &gamma, Plant::graph_type &system_graph,
                                 Parameters &settings) {
        ...
        DGGML::WithRule<GT> mt_stochastic_retraction("mt_stochastic_retraction", mt_retraction_lhs1, mt_retraction_rhs1,
                                                     [&](auto &lhs, auto &m) {
                                                         ...
                                                         auto len = DGGML::calculate_distance(node_i_data.position,
                                                                                              node_j_data.position);
                                                         double propensity = 10.0 * DGGML::heaviside(
...
//                    });
    ...
    void create_zippering_rules(DGGML::Grammar<Plant::graph_type> &gamma, Plant::graph_type &system_graph,
                                Parameters &settings) {
        ...
        DGGML::WithRule<GT> zipper_retraction("zipper_retraction", zipper_retraction_lhs_graph1,
                                              ...
                                              [&](auto &lhs, auto &m) {
                                                  ...
                                                  auto len = DGGML::calculate_distance(node_i_data.position,
                                                                                       node_j_data.position);
                                                  double propensity =
                                                          10.0 * DGGML::heaviside(settings.DIV_LENGTH_RETRACT, len);
                                                  return propensity;
                                              }, [](auto &lhs, auto &rhs, auto &m1, auto &m2) {
                    //reset the unit vector
                    DGGML::set_unit_vector(rhs[m2[3]].position, rhs[m2[1]].position,
    ...
    void create_crossover_rules(DGGML::Grammar<Plant::graph_type> &gamma, Plant::graph_type &system_graph,
                                Parameters &settings) {
...
//            //gamma.addRule(catastrophe_case3);
    ...
    void create_destruction_rules(DGGML::Grammar<Plant::graph_type> &gamma, Plant::graph_type &system_graph,
                                  Parameters &settings) {
    ...
    void create_creation_rules(DGGML::Grammar<Plant::graph_type> &gamma, Plant::graph_type &system_graph,
                               Parameters &settings) {
...
//                                                      }
    ...
    void create_clasp_rules(DGGML::Grammar<Plant::graph_type> &gamma, Plant::graph_type &system_graph,
                            Parameters &settings) {
...
//
    ...
    void create_recovery_rules(DGGML::Grammar<Plant::graph_type> &gamma, Plant::graph_type &system_graph,
                               Parameters &settings) {
